...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2020 at 07:47 AM
...
(202, 'sindhu', 'sindhu@gmail.com', 986547312, '2020-02-03', '123'),
...
(502, 'Nike', 'https://c4.wallpaperflare.com/wallpaper/601/305/95/nike-full-hd-wallpaper-preview.jpg', 100, 10, 'comfort', 401, 'average', 102),
...
(505, 'iphone', 'https://thumbs.dreamstime.com/b/black-smartphone-iphone-white-screen-background-vector-eps-icon-145063105.jpg', 2500, 10, 'nice', 402, 'no remarks', 102),
...
--
ALTER TABLE `bill_details_table`
  MODIFY `bill_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=713;

--
-- AUTO_INCREMENT for table `bill_table`
--
ALTER TABLE `bill_table`
  MODIFY `bill_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=612;
...
--
ALTER TABLE `seller_signup_table`
  MODIFY `seller_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
